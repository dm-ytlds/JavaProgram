...
<script type="text/javascript">
	...
	$(function(){
		...
		/*
		* 打开模态窗口之前，将需要早下拉框展示的数据先从数据库中查出来
		* */
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#editClueModal" id="editBtn"><span class="glyphicon glyphicon-pencil"></span> 修改</button>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=b5c5f6883abb422cb00f06f9920391c1';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
