 ...
 */
package com.demi.module.main;

import com.gn.GNAvatarView;
import com.demi.global.factory.AlertCell;
...
public class Main implements Initializable {
    ...
    private String path = "/com/demi/theme/css/";
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/com/demi/module/main/Popover.fxml")));
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/com/demi/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void loadContentPopup() {
        try {
            popContent = FXMLLoader.load(getClass().getResource("/com/demi/module/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/com/demi/theme/css/poplight.css").toExternalForm());
    ...
    private void openMessages() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/demi/module/media/man.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/demi/module/media/woman.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/demi/module/media/man.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/com/demi/theme/css/custom-scroll.css").toExternalForm());


            pop.getRoot().getStylesheets().add(getClass().getResource("/com/demi/theme/css/poplight.css").toExternalForm());
    ...
    private void openNotification() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/demi/module/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/demi/module/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/demi/module/media/notification-35.png").toExternalForm()));
