    ...
    private void lendBook() {
        try {
            ...
            if (book == null || Constant.STATUS_LEND.equals(book.getStatus())){
                Alerts.warning("未选择或选择有误","请选择可借阅的书籍");
                return;
            }
 ...
 */
    private void initLendStage(Book book) throws IOException {
        ...
        loader.setLocation(App.class.getResource("/com/demi/module/book/BookLendView.fxml"));
    ...
    private void initStage(Book book) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(App.class.getResource("/com/demi/module/book/BookHandleView.fxml"));
        StackPane target = (StackPane) loader.load();
