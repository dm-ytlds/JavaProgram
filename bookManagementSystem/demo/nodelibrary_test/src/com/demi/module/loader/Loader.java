 ...
 */
package com.demi.module.loader;
...
public class Loader extends Preloader {
    ...
    public void init(){
        try {
            view = FXMLLoader.load(getClass().getResource("/com/demi/module/loader/loader.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primary){
        ...
        scene.getStylesheets().add(getClass().getResource("/com/demi/theme/css/fonts.css").toExternalForm());
        progressBar = (JFXProgressBar) scene.lookup("#progressBar");
        primary.getIcons().add(new Image("/com/demi/module/media/icon.png"));
