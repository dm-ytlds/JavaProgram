...
public class AdminDetail extends GNControl {
    ...
    @Override
    public Node icon() {
        Image image = new Image(getClass().getResource("/com/demi/media/img/avatar.png").toExternalForm());
...
//        System.out.println(getName());
        ...
        gnAvatar.setImage(new Image(getClass().getResource("/com/demi/media/img/avatar.png").toExternalForm()));
        ...
        popOver.getRoot().getStylesheets().add(getClass().getResource("/com/demi/theme/css/poplight.css").toExternalForm());
